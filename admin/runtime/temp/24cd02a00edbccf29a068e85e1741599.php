<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\PHP\PHPTutorial\WWW\test123\admin\public/../app/admin\view\index\index.html";i:1528979561;s:67:"D:\PHP\PHPTutorial\WWW\test123\admin\app\admin\view\common\css.html";i:1528943849;s:70:"D:\PHP\PHPTutorial\WWW\test123\admin\app\admin\view\common\script.html";i:1528943849;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="<?php echo url('admin/PartOrderUser/part_order_list'); ?>">交易者账户</a>
                        </li>
                        <li><a class="J_menuItem" href="<?php echo url('admin/PartOrderUser/part_order_list'); ?>">交易账户</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="<?php echo url('admin/Trade/online_order'); ?>">在场订单</a>
                        </li>
