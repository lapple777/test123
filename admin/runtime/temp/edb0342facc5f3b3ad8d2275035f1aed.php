<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\PHP\PHPTutorial\WWW\test123\admin\public/../app/admin\view\account\account-info.html";i:1528943849;s:67:"D:\PHP\PHPTutorial\WWW\test123\admin\app\admin\view\common\css.html";i:1528943849;s:70:"D:\PHP\PHPTutorial\WWW\test123\admin\app\admin\view\common\script.html";i:1528943849;}*/ ?>
<!DOCTYPE html>
<html>
                                    ...
                                    <div class="">
                                        <form class="form-horizontal m-t" id="signupForm">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input id="email" name="email" class="form-control" aria-required="true" type="email">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label">身份证号：</label>
                                                <div class="col-sm-8">
                                                    <input id="id_card" name="id_card" class="form-control" aria-required="true" type="text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input id="bank_id" name="bank_id" class="form-control" aria-required="true" type="text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="card_box col-sm-offset-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input id="create_time" name="create_time" class="laydate-icon form-control layer-date">
                                                </div>
                                            </div>
                                            <div class="form-group">
