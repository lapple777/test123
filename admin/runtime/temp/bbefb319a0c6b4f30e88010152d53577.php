<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"F:\gitcrm\admin\public/../app/admin\view\auth\auth-edit.html";i:1530527976;s:46:"F:\gitcrm\admin\app\admin\view\common\css.html";i:1530166755;s:49:"F:\gitcrm\admin\app\admin\view\common\script.html";i:1529054880;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <form action="" method="post"  id="form-group-conf">
                <table class="table table-bordered">
                    <tr>
                        <td>权限名：</td>
                        <td>
                            <input type="text" class="form-control" value="<?=$auth['title']?>" placeholder="" id="authname" name="authname">
                        </td>
                    </tr>
                    <tr>
                        <td>权限标识：</td>
                        <td>
                            <input type="text" class="form-control" value="<?=$auth['name']?>" placeholder="" id="auth" name="auth"><br/>
                            <span class="f-12">输入模块/控制器/方法即可 例如 admin/ShowNav/index</span>
                        </td>
                        <input type="hidden" name="aid" value="<?=$auth['id']?>">
                    </tr>
                </table>
