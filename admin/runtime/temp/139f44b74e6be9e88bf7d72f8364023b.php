<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"F:\gitcrm\admin\public/../app/trader\view\brm\outmoney.html";i:1529398937;s:47:"F:\gitcrm\admin\app\trader\view\common\css.html";i:1529054880;s:50:"F:\gitcrm\admin\app\trader\view\common\script.html";i:1529054880;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <form class="form-horizontal m-t" method="post" id="commentForm">
                    <table class="table">
                        <tr>
                            ...
                            <td><input  n type="text" class="form-control" readonly value="<?=$blance?>"></td>
                        </tr>
                        <tr>
                            <td class="text-right">出金金额</td>
                            <td><input id="inmoney" name="outmoney" type="text" class="form-control"></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
