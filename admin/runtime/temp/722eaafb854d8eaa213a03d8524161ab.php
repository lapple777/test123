<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"F:\gitcrm\admin\public/../app/admin\view\menu\menu-edit.html";i:1530522394;s:46:"F:\gitcrm\admin\app\admin\view\common\css.html";i:1530166755;s:49:"F:\gitcrm\admin\app\admin\view\common\script.html";i:1529054880;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <form action="" method="post"  id="form-group-conf">
                <table class="table table-bordered">
                    <tr>
                        <td>菜单名：</td>
                        <td>
                            <input type="text" class="form-control" value="<?=$menu['name']?>" placeholder="" id="menuname" name="menuname">
                        </td>
                    </tr>
                    <tr>
                        <td>标识：</td>
                        <td>
                            <input type="text" class="form-control" value="<?=$menu['navUrl']?>" placeholder="" id="navurl" name="navurl"><br/>
