                        ...
                        <li class="active">
                            <ul class="nav nav-tabs">
                                ...
                                <li class="success-element">
                                    ...
                                    <a data-toggle="tab" href="#tab-2" aria-expanded="false">客户出金审核</a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" onclick="user_withdraw_success(this,'<?php echo url('/admin/FundsManagement/userWithdraw_success',['user_id'=>$value['user_id']]); ?>')">出金成功</a>
                                        </td>
                                    </tr>
                                    <?php }?>
                                    </tbody>
...
<script>
    ...
    //客户出金成功
    function user_withdraw_success(that,url) {
    ...
    //客户出金失败
    function user_withdraw_fail() {
        
    }
    
    //IB出金成功
    function IB_withdraw_success() {
        
    }
    //IB出金失败
    function IB_withdraw_fail() {
