                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example">
                                ...
                                <?php foreach($trader_list as $trader){?>
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                            <a href="javascript:void(0)" onclick="changePwd('<?php echo url("Trader/changePwd",['account'=>$trader['account']]); ?>')">修改密码</a>
                                            <a href="javascript:void(0)" onclick="fundAllot('资金分配','<?php echo url("FundAllot/fundAllot",['account'=>$trader['account']]); ?>','500','300')">分配资金</a>
                                        </td>
                                    </tr>
                                <?php }?>
